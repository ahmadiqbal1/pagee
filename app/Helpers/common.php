...
if (!function_exists('checkSettingsAutoresponder')) {
    ...
    function checkSettingsAutoresponder($landing_page,$form_data) {

        if (isset($landing_page->settings['autoresponder'])) {

            $autoresponder = $landing_page->settings['autoresponder'];
...
if (!function_exists('ruleIntergrationForAddContact')) {
    ...
    function ruleIntergrationForAddContact($landing_page,$form_data) {
